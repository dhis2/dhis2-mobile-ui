...
fun InputNegativeIntegerScreen() {
    ColumnComponentContainer {
        ...
        SubTitle("Input Negative Integer with legend", textColor = TextColor.OnSurfaceVariant)
        InputNegativeInteger(
            title = "Label",
        ...
        SubTitle("Input Negative Integer with Supporting text", textColor = TextColor.OnSurfaceVariant)
        InputNegativeInteger(
            title = "Label",
        ...
        SubTitle("Input Negative Integer with Supporting text and legend", textColor = TextColor.OnSurfaceVariant)
        ...
        SubTitle("Input Negative Integer with error, warning text and legend", textColor = TextColor.OnSurfaceVariant)
