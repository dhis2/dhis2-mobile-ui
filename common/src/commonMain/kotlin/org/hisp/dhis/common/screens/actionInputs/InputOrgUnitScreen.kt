...
fun InputOrgUnitScreen() {
    ColumnComponentContainer(title = ActionInputs.INPUT_ORG_UNIT.label) {
        ColumnComponentItemContainer("Basic Org. unit ") {
        ...
        ColumnComponentItemContainer("Basic Org. unit with content ") {
        ...
        ColumnComponentItemContainer("Error Org. unit required field ") {
        ...
        ColumnComponentItemContainer("Disabled Org. unit with content ") {
