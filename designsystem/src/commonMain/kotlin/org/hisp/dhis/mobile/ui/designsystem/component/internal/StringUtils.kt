...
internal class PrefixTransformation(
    private val prefix: String,
    val enabled: Boolean,
) : VisualTransformation {
    override fun filter(text: AnnotatedString): TransformedText = prefixFilter(text, prefix, enabled = enabled)
}
...
internal fun prefixFilter(
    ...
    val out =
        AnnotatedString(
            ...
            AnnotatedString(
                text.text,
                spanStyle =
                    DHIS2SCustomTextStyles.inputField.copy(
    ...
    val numberOffsetTranslator =
        object : OffsetMapping {
            override fun originalToTransformed(offset: Int): Int = offset + prefixOffset
...
internal class SuffixTransformer(
    val suffix: String,
) : VisualTransformation {
