...
class InputLongTextTest {
    ...
    fun shouldDisplayInputTextCorrectly() {
        ...
        rule.onNodeWithTag("INPUT_LONG_TEXT_LEGEND", useUnmergedTree = true).assertDoesNotExist()
        rule.onNodeWithTag("INPUT_LONG_TEXT_SUPPORTING_TEXT", useUnmergedTree = true).assertDoesNotExist()
    }
    ...
    fun shouldAllowUserInputWhenEnabled() {
        ...
        rule.onNodeWithTag("INPUT_LONG_TEXT").assertExists()
        rule.onNodeWithTag("INPUT_LONG_TEXT_FIELD", useUnmergedTree = true).performTextInput("Input")
        rule.onNodeWithTag("INPUT_LONG_TEXT_FIELD", useUnmergedTree = true).assert(hasText("Input"))
    }
    ...
    fun shouldNotAllowUserInputWhenDisabled() {
        ...
        rule.onNodeWithTag("INPUT_LONG_TEXT").assertExists()
        rule.onNodeWithTag("INPUT_LONG_TEXT_FIELD", useUnmergedTree = true).assertIsNotEnabled()
    }
    ...
    fun shouldShowResetButtonWhenTextFieldHasContent() {
        ...
        rule.onNodeWithTag("INPUT_LONG_TEXT").assertExists()
        rule.onNodeWithTag("INPUT_LONG_TEXT_FIELD", useUnmergedTree = true).assertExists()
        rule.onNodeWithTag("INPUT_LONG_TEXT_FIELD", useUnmergedTree = true).performTextInput("Input")
    ...
    fun shouldDeleteContentWhenResetButtonIsClickedAndHideResetButton() {
        ...
        rule.onNodeWithTag("INPUT_LONG_TEXT_FIELD", useUnmergedTree = true).assertTextEquals("")
    ...
    fun shouldShowLegendCorrectly() {
        ...
        rule.onNodeWithTag("INPUT_LONG_TEXT").assertExists()
        rule.onNodeWithTag("INPUT_LONG_TEXT_LEGEND", useUnmergedTree = true).assertExists()
        rule.onNodeWithTag("INPUT_LONG_TEXT_LEGEND", useUnmergedTree = true).assertHasNoClickAction()
    }
    ...
    fun shouldShowSupportingTextCorrectly() {
        ...
        rule.onNodeWithTag("INPUT_LONG_TEXT").assertExists()
        rule.onNodeWithTag("INPUT_LONG_TEXT_SUPPORTING_TEXT", useUnmergedTree = true).assertExists()
    }
}
